...
def truncate_table(table):
    ...
    db = pymysql.connect(host="localhost",user="root",passwd="1q2w3e4r5t",database="modeleva_new")
    #使用cursor()方法获取操作游标
    cursor = db.cursor()
...
def input_table(data,table):
    # db = pymysql.connect(host="localhost",user="root",passwd="12345.zcf",database="fjkz",charset='utf8')
    db = pymysql.connect(host="localhost",user="root",passwd="1q2w3e4r5t",database="modeleva_new",charset='utf8')
    #使用cursor()方法获取操作游标
    cursor = db.cursor()
...
#     
#     df_1=df[df['region_code'].str.contains('_')]
#     
#     df_1['region_code_']=df_1['region_code'].str.split('_',expand=True,n=2)[0]
#     df_1['org_name_']=df_1['region_code'].str.split('_',expand=True,n=2)[1]
#     
#     df_1_org=pd.merge(df_1,
#          dict_org,
#          how='left',left_on='org_name_',right_on='military_name_cn',sort=True)
#     
#     
#     df_1_org=df_1_org.loc[:,['field', 'indicator_id', 'region_code_',
#                          'indicator_name','scope','score',
#                          'year','id','military_level','military_name_cn']]
#     
#     df_1_org=df_1_org.rename(columns={'region_code_':'region_code',
#                                   'id':'org_id',
#                                   'military_level':'eva_level',
#                                   'military_name_cn':'org_name'})
#     print(df_1_org.columns)
#     df_2=df[df['region_code'].str.contains('_')==False]
#     df_2['eva_level']=None
#     df_2['org_id']=None
#     df_2['org_name']=None
#     print(df_2.columns)
#     
#     df_org=pd.concat([df_1_org,df_2])
# 
#     
...
#     if field_.find('all')>-1:
#         df_org.to_sql(data_table,engine,if_exists='replace',index=False)
#     else:
